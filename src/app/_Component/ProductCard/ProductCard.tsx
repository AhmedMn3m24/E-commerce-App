...
export default function ProductCard({ product }: { product: any }) {
  ...
  return (
    <div
      className="product-item flex flex-col relative mt-10 rounded-xl shadow-md pt-6 hover:shadow-lg
                    transition-all duration-300 p-3 cursor-pointer border border-gray-200 bg-white hover:scale-[1.02]"
    >
      <Link href={`/ProductDetalis/${product.id}`}>
        <img
          src={product.imageCover}
